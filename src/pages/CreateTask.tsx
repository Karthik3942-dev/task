          ...
          >
            ...
            {teamProjects.map((project) => {
              ...
              return (
                <div
                  key={project.id}
                  className="border-t border-cyan-200/50 dark:border-purple-500/50 pt-4 mt-6"
                >
                  <h3
                        ...
                        <div className="overflow-x-auto mt-6">
                          <table className="w-full border-2 border-gray-800 dark:border-purple-500/50 text-sm text-left rounded-xl overflow-hidden shadow-2xl bg-black/90 dark:bg-black/95">
                            <thead className="bg-gray-900/90 dark:bg-purple-900/80 text-white uppercase">
                              <tr>
                                <th className="p-4 border border-gray-700 dark:border-purple-600/50 font-bold text-white">
                                  🎫 Linked Ticket
                                </th>
                                <th className="p-4 border border-gray-700 dark:border-purple-600/50 font-bold text-white">
                                  🆔 Task ID
                            ...
                            <tbody>
                              {tasks.map((task, idx) => {
                                ...
                                return (
                                  <tr
                                    key={task.id}
                                    className={`${rowBg} text-white hover:bg-gray-700/70 transition-colors border-b border-gray-700 dark:border-purple-600/30`}
                                  >
